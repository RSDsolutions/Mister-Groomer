...
export default function Nosotros() {
  return (
    <div className="animate-in fade-in duration-500 bg-white">
      {/* Hero Mini with Bubbles */}
      <div className="bg-brand-teal pt-16 pb-20 px-4 relative overflow-hidden">
        <HeroBubbles />
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-6 pt-6 border-t border-gray-100">
              <div className="flex gap-4 items-center">
                ...
                <div>
                  <h4 className="font-bold text-brand-dark text-xl">9+</h4>
                  <p className="text-xs text-brand-muted uppercase font-semibold tracking-wider">Años Exp.</p>
                </div>
              </div>
              <div className="flex gap-4 items-center">
                <div className="bg-brand-orange/10 p-3 rounded-xl text-brand-orange"><Heart className="w-6 h-6" /></div>
                <div>
                  <h4 className="font-bold text-brand-dark text-xl">100%</h4>
      ...
      <div className="bg-[#FAFAFA] py-24 border-y border-gray-100">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-24">
            <div className="bg-brand-dark-teal rounded-3xl p-10 lg:p-12 text-white shadow-xl transform transition-transform hover:-translate-y-2">
              ...
              <p className="text-xl sm:text-2xl font-light leading-relaxed">
                "Mantener lindas, sanas y felices a las mascotas de nuestros clientes mediante servicios de estética animal de primer nivel, en un ambiente amigable y seguro."
              </p>
            </div>
          ...
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold text-brand-dark-teal mb-4">Nuestra Trayectoria</h2>
            <p className="text-brand-muted max-w-2xl mx-auto">El camino que nos trajo hasta hoy.</p>
          </div>
      ...
      <div className="py-20 text-center max-w-4xl mx-auto px-4">
        <h2 className="text-3xl font-bold text-brand-dark-teal mb-6">¿Quieres ser parte de la familia Mr. Groomer?</h2>
        <p className="text-brand-muted mb-8 text-lg">Confía la estética de tu mejor amigo a manos expertas.</p>
        <Link to="/reservar" className="inline-flex items-center gap-2 bg-brand-teal hover:bg-brand-dark-teal text-white px-8 py-4 rounded-full font-bold text-lg transition-all shadow-lg hover:-translate-y-1">
          Agendar Cita Hoy
        </Link>
      </div>
    </div>
