    ...
    <div className="bg-[#FAFAFA] min-h-screen">
      ...
      <div className="hero-bg relative overflow-hidden pt-12 pb-28 px-4">
        ...
        <div className="max-w-7xl mx-auto text-center relative z-10">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">
            <WordReveal>Agenda tu Cita</WordReveal>
          </h1>
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
          ...
          <div
            data-reveal="left"
            className="lg:col-span-3 bg-white rounded-3xl p-6 sm:p-10 shadow-xl border border-gray-100"
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <input
                    required type="text" name="ownerName" value={formData.ownerName} onChange={handleChange}
                    className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-brand-teal focus:ring-2 focus:ring-brand-teal/20 outline-none transition-all bg-gray-50/50"
                ...
                <div className="space-y-2">
                  ...
                  <input
                    required type="text" name="petName" value={formData.petName} onChange={handleChange}
                    className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-brand-teal focus:ring-2 focus:ring-brand-teal/20 outline-none transition-all bg-gray-50/50"
                    placeholder="Ej. Max"
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <select
                    name="petType" value={formData.petType} onChange={handleChange}
                    className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-brand-teal focus:ring-2 focus:ring-brand-teal/20 outline-none transition-all bg-gray-50/50"
                  >
                ...
                <div className="space-y-2">
                  ...
                  <input
                    required type="text" name="breed" value={formData.breed} onChange={handleChange}
                    className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-brand-teal focus:ring-2 focus:ring-brand-teal/20 outline-none transition-all bg-gray-50/50"
                    placeholder="Ej. Poodle Mini"
                  />
                </div>
              </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-12 pr-4 py-3 rounded-xl border border-gray-200 focus:border-brand-teal focus:ring-2 focus:ring-brand-teal/20 outline-none transition-all bg-gray-50/50"
                    />
                  </div>
                </div>
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <select
                      ...
                      className="w-full pl-12 pr-4 py-3 rounded-xl border border-gray-200 focus:border-brand-teal focus:ring-2 focus:ring-brand-teal/20 outline-none transition-all bg-gray-50/50 appearance-none"
                    >
              ...
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-brand-teal focus:ring-2 focus:ring-brand-teal/20 outline-none transition-all bg-gray-50/50 resize-none"
                  placeholder="Alergias, miedos, comportamiento..."
                />
              </div>
          ...
          {/* Contact Column */}
          <div className="lg:col-span-2 space-y-6" data-reveal="right">
